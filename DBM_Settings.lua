...
function RUI:DBMSettings(layout)
  ...
  DBT_AllPersistentOptions["RedtuzkUI"] = {
    ...
    elseif layout == "healer" then
      DBM:CreateProfile('RedtuzkUI_Healer')
      DBM_AllSavedOptions["RedtuzkUI_Healer"] = {
    		["DontShowFarWarnings"] = true,
    		["ChosenVoicePack"] = "None",
    		["DontShowHudMap2"] = false,
    		["AlwaysPlayVoice"] = false,
      ...
      DBT_AllPersistentOptions["RedtuzkUI_Healer"] = {
    		["DBM"] = {
    			["StartColorPR"] = 1,
    			["Scale"] = 1,
    			["EnlargeBarsPercent"] = 0.125,
    			...
    			["EndColorAEG"] = 0.0431372549019608,
    			["StartColorAEB"] = 0.458823529411765,
    			["HugeTimerY"] = -131.000289916992,
    			["HugeTimerX"] = -251.000030517578,
    			["EndColorDB"] = 1,
    			["EndColorUIB"] = 0.0117647058823529,
    			["StartColorAB"] = 1,
    			["StartColorDB"] = 1,
    			...
    			["EndColorPB"] = 0.286274509803922,
    			["StartColorIG"] = 0.968627450980392,
    			["TimerY"] = 238.000793457031,
    		},
    	}
    end
    if IsAddOnLoaded("AddOnSkins") then
      local AS, ASL = unpack(AddOnSkins)
      AS:SetOption("DBMFont", "Gilroy Bold")
    end
end
